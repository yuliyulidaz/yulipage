(function () {
    ...
    window.ResultView = ({
        ...
        pageSize, pageHighlights, mockupSpreadIdx, spreads,
        ...
        return (
            <div className="min-h-screen bg-slate-100 flex flex-col lg:flex-row h-screen overflow-hidden">
                ...
                <div className="hidden lg:flex w-full h-full justify-center items-center bg-gray-50 overflow-auto min-h-[800px]">
                    <div className="flex flex-row items-start gap-8 py-10">
                        ...
                        <div className="relative shadow-2xl transition-all duration-300">
                            ...
                            {/* Page Navigation (Rounded Square INSIDE Edge) */}
                            {activeTab !== 'mockup' && (
                                <>
                                    {currentPageIdx > 0 && (
                                        <button
